...
exe 'command! -bang -nargs=? -range=-1' s:addr_wins '-complete=customlist,fugitive#GrepComplete Ggrep  exe fugitive#GrepCommand(<line1>, <count>, +"<range>", <bang>1, "<mods>", <q-args>." -q")'
...
exe 'command! -bar -bang -nargs=* -complete=customlist,fugitive#EditComplete Gdiff exe "if &previewwindow|echom \"ignoring...\"|else|call fugitive#Diffsplit(1, <bang>1, \"vertical <mods>\", <q-args>)|endif"'
