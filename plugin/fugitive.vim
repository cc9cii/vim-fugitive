...
exe 'command! -bar -bang -nargs=* -complete=customlist,fugitive#EditComplete Gdiff exe "if &previewwindow|echom \"ignoring...\"|else|call fugitive#Diffsplit(1, <bang>1, \"<mods>\", <q-args>)|endif"'
